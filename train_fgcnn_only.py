...
belly_classifier = nn.fg_classifier(shared_layers, belly_roi, cfg.num_rois,nb_classes=10)
breast_classifier = nn.fg_classifier(shared_layers, breast_roi, cfg.num_rois,nb_classes=10)
tail_classifier = nn.fg_classifier(shared_layers, tail_roi, cfg.num_rois,nb_classes=10)
bird_classifier_output = [head_classifier,legs_classifier,wings_classifier,back_classifier,belly_classifier,breast_classifier,tail_classifier]
